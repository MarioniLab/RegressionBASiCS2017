...
mouse.genes <- read.table("/Users/eling01/Google Drive File Stream/My Drive/BASiCS_add-on/Data/Genenames.txt", sep = '\t', header = TRUE, stringsAsFactors = FALSE)
rownames(mouse.genes) <- mouse.genes[,1]
```

```{r}
# Read in MCMC chains run on cells from day 2, day 4 and day7 post-infection
MCMCs <- readRDS("/Users/eling01/Google Drive File Stream/My Drive/BASiCS_add-on/Analysis/Results/Differential_testing/All_CD4diff.rds")
...
write.csv(Sig.2_4, "/Users/eling01/Google Drive File Stream/My Drive/BASiCS_add-on/Analysis/Results/Differential_testing/CD4diff/DV_day2_day4.csv")
...
write.csv(Sig.2_7, "/Users/eling01/Google Drive File Stream/My Drive/BASiCS_add-on/Analysis/Results/Differential_testing/CD4diff/DV_day2_day7.csv")
...
write.csv(Sig.4_7, "/Users/eling01/Google Drive File Stream/My Drive/BASiCS_add-on/Analysis/Results/Differential_testing/CD4diff/DV_day4_day7.csv")
```
...
write.table(genenames, 
            "/Users/eling01/Google Drive File Stream/My Drive/BASiCS_add-on/Analysis/Results/Differential_testing/CD4diff/Up-Up.txt", quote = FALSE, 
...
write.table(genenames, 
            "/Users/eling01/Google Drive File Stream/My Drive/BASiCS_add-on/Analysis/Results/Differential_testing/CD4diff/Down-Down.txt", quote = FALSE, 
            col.names = FALSE, row.names = FALSE)
...
write.table(genenames, 
            "/Users/eling01/Google Drive File Stream/My Drive/BASiCS_add-on/Analysis/Results/Differential_testing/CD4diff/Down-Up.txt", quote = FALSE, 
            col.names = FALSE, row.names = FALSE)
...
write.table(genenames, 
            "/Users/eling01/Google Drive File Stream/My Drive/BASiCS_add-on/Analysis/Results/Differential_testing/CD4diff/Up-Down.txt", quote = FALSE, 
            col.names = FALSE, row.names = FALSE)
...
```{r}
# Normalize data
input <- read.table("/Users/eling01/Google Drive File Stream/My Drive/BASiCS_add-on/Data/Test_Data/CD4_diff.txt", sep = "\t")

#### Read in Spike-ins
ERCC.conc <- read.table("/Users/eling01/Google Drive File Stream/My Drive/BASiCS_add-on//Data/Raw_data/CD4_Diff/ERCC_malaria.txt", header=TRUE, sep = "\t", fill = TRUE)
...
ggsave("/Users/eling01/Google Drive File Stream/My Drive/BASiCS_add-on/Analysis/Manuscript/Figures/Fig6.pdf", plot = Fig6, width = 10, height = 10)
...
ggsave("/Users/eling01/Google Drive File Stream/My Drive/BASiCS_add-on/Analysis//Manuscript/Figures/Revisions/FigS6.pdf", FigS6, height = 18, width = 15)
```
