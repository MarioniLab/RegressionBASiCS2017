...
Test_Regression <- BASiCS_TestDE(MCMC.naive.new, MCMC.active.new, EpsilonM = 0,
                                 Plot = FALSE, PlotOffset = FALSE,
                                 GroupLabel1 = "Naive_Regression", 
                                 GroupLabel2 = "Active_Regression",
                                 GenesSelect = genes)

Test_NonRegression <- BASiCS_TestDE(MCMC.naive.old, MCMC.active.old, EpsilonM = 0,
                                 Plot = FALSE, PlotOffset = FALSE,
...
NumberDE.Regression <- sum(Test_Regression$TableMean$ResultDiffMean != "NoDiff" &
                             Test_Regression$TableMean$ResultDiffMean != "ExcludedByUser")
NumberDE.NonRegression <- sum(Test_NonRegression$TableMean$ResultDiffMean != "NoDiff" &
                                Test_NonRegression$TableMean$ResultDiffMean != "ExcludedByUser")
Overlap <- length(intersect(Test_Regression$TableMean$GeneName[
                                  Test_Regression$TableMean$ResultDiffMean != "NoDiff" &
                                    Test_Regression$TableMean$ResultDiffMean != "ExcludedByUser"],
                            Test_NonRegression$TableMean$GeneName[
                                  Test_NonRegression$TableMean$ResultDiffMean != "NoDiff" &
                                    Test_NonRegression$TableMean$ResultDiffMean != "ExcludedByUser"]
                         ))
...
genes <- intersect(Test_Regression$TableMean$GeneName[
                                  Test_Regression$TableMean$ResultDiffMean == "NoDiff"],
                            Test_NonRegression$TableMean$GeneName[
                                  Test_NonRegression$TableMean$ResultDiffMean == "NoDiff"]
                         )
NumberDV.Regression <- sum(Test_Regression$TableDisp$ResultDiffDisp != "NoDiff" &
                         Test_Regression$TableDisp$ResultDiffDisp != "ExcludedFromTesting" &
                           Test_Regression$TableDisp$GeneName %in% genes)
NumberDV.NonRegression <- sum(Test_NonRegression$TableDisp$ResultDiffDisp != "NoDiff" &
                         Test_NonRegression$TableDisp$ResultDiffDisp != "ExcludedFromTesting" &
                           Test_NonRegression$TableDisp$GeneName %in% genes)
Overlap <- length(intersect(Test_Regression$TableDisp$GeneName[
                                  Test_Regression$TableDisp$ResultDiffDisp != "NoDiff" &
                                  Test_Regression$TableDisp$ResultDiffDisp != "ExcludedFromTesting" &
                           Test_Regression$TableDisp$GeneName %in% genes
                                  ],
                            Test_NonRegression$TableDisp$GeneName[
                                  Test_NonRegression$TableDisp$ResultDiffDisp != "NoDiff" &
                                  Test_NonRegression$TableDisp$ResultDiffDisp != "ExcludedFromTesting" &
                           Test_NonRegression$TableDisp$GeneName %in% genes
                                  ]
                         ))
...
# Compare differential dispersion and differential residual dispersion
NumberDrV.Regression <- sum(Test_Regression$TableResDisp$ResultDiffResDisp != "NoDiff" &
                         Test_Regression$TableResDisp$ResultDiffResDisp != "ExcludedFromTesting" & 
                           Test_Regression$TableResDisp$ResultDiffResDisp != "ExcludedByUser")
NumberDV.NonRegression <- sum(Test_NonRegression$TableDisp$ResultDiffDisp != "NoDiff" &
                         Test_NonRegression$TableDisp$ResultDiffDisp != "ExcludedFromTesting" &
                           Test_NonRegression$TableDisp$ResultDiffDisp != "ExcludedByUser")
Overlap <- length(intersect(Test_Regression$TableResDisp$GeneName[
                                  Test_Regression$TableResDisp$ResultDiffResDisp != "NoDiff" &
                                  Test_Regression$TableResDisp$ResultDiffResDisp != "ExcludedFromTesting" & Test_Regression$TableResDisp$ResultDiffResDisp != "ExcludedByUser"
                                  ],
                            Test_NonRegression$TableDisp$GeneName[
                                  Test_NonRegression$TableDisp$ResultDiffDisp != "NoDiff" &
                                  Test_NonRegression$TableDisp$ResultDiffDisp != "ExcludedFromTesting" & Test_NonRegression$TableDisp$ResultDiffDisp != "ExcludedByUser"
                                  ]
                         ))

draw.pairwise.venn(area1 = NumberDV.NonRegression, area2 = NumberDrV.Regression, cross.area = Overlap, 
                   category = c("Differential dispersion :Non Regression case", 
                                "Differential residual dispersion: Regression case"), euler.d = TRUE, scaled = TRUE,
                   fill = c("steelblue4", "coral3"))

# Visualize the number of genes that can be tested between the two models
NumberTested.Regression <- sum(Test_Regression$TableResDisp$ResultDiffResDisp != "ExcludedFromTesting" & 
                           Test_Regression$TableResDisp$ResultDiffResDisp != "ExcludedByUser")
NumberTested.NonRegression <- sum(Test_NonRegression$TableDisp$ResultDiffDisp != "ExcludedFromTesting" &
                           Test_NonRegression$TableDisp$ResultDiffDisp != "ExcludedByUser")
Overlap <- length(intersect(Test_Regression$TableResDisp$GeneName[Test_Regression$TableResDisp$ResultDiffResDisp != "ExcludedFromTesting" & 
                           Test_Regression$TableResDisp$ResultDiffResDisp != "ExcludedByUser"],
                            Test_NonRegression$TableDisp$GeneName[
                              Test_NonRegression$TableDisp$ResultDiffDisp != "ExcludedFromTesting" &
                           Test_NonRegression$TableDisp$ResultDiffDisp != "ExcludedByUser"]
...
draw.pairwise.venn(area1 = NumberTested.NonRegression, 
                   area2 = NumberTested.Regression, cross.area = Overlap, 
                   category = c("Differential dispersion testing: Non Regression case", 
                                "Differential residual dispersion testing: Regression case"), euler.d = TRUE, scaled = TRUE,
                   fill = c("steelblue4", "coral3"))
```
