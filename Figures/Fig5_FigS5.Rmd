...
Test_Regression <- BASiCS_TestDE(MCMC.naive.new, MCMC.active.new,
                                 Plot = FALSE, PlotOffset = FALSE,
                                 GroupLabel1 = "Naive_Regression", GroupLabel2 = "Active_Regression")

Test_NonRegression <- BASiCS_TestDE(MCMC.naive.old, MCMC.active.old,
                                 Plot = FALSE, PlotOffset = FALSE,
                                 GroupLabel1 = "Naive_NonRegression", GroupLabel2 = "Active_NonRegression")

# First we compare the DV genes between regression and non-regression case using the deltas
