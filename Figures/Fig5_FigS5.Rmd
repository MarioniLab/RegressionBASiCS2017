...
```{r}
# Read in data
MCMC.naive <- readRDS("Mixed_Tcells/MCMC_naive.rds")
MCMC.mixed <- readRDS("Mixed_Tcells/MCMC_mixed.rds")
Data.naive <- readRDS("Mixed_Tcells/Data_naive.rds")
Data.mixed <- readRDS("Mixed_Tcells/Data_mixed.rds")
