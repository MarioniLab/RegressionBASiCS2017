...
```{r}
df <- df[df$Regulation != "Other",]
df <- df[order(df$Regulation),]
df$Genename <- mouse.genes[rownames(df),2] 

write.xlsx(df, "/Users/nils/Dropbox (Personal)/BASiCSplus/Revisions/TableS2_current.xlsx",
           row.names = TRUE)
```
