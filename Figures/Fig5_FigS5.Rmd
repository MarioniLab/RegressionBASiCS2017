...
write.xlsx(df.out, "/Users/nils/Dropbox (Personal)/BASiCSplus/Revisions/TableS2_current.xlsx",
           row.names = TRUE)
```
...
write.table(as.data.frame(rownames(df)), "/Users/nils/Google Drive File Stream/My Drive/BASiCS_add-on/Analysis/Revisions/background.txt", sep = "\t", 
            row.names = FALSE, col.names = FALSE, quote = FALSE)

write.table(as.data.frame(rownames(df)[df$Regulation == "Up-regulated, lower variability"]),
            "/Users/nils/Google Drive File Stream/My Drive/BASiCS_add-on/Analysis/Revisions/CD4_activation_DEup_DVdown.txt", sep = "\t", 
            row.names = FALSE, col.names = FALSE, quote = FALSE)

write.table(as.data.frame(rownames(df)[df$Regulation == "Up-regulated, higher variability"]),
            "/Users/nils/Google Drive File Stream/My Drive/BASiCS_add-on/Analysis/Revisions/CD4_activation_DEup_DVup.txt", sep = "\t", 
            row.names = FALSE, col.names = FALSE, quote = FALSE)

write.table(as.data.frame(rownames(df)[df$Regulation == "Down-regulated, lower variability"]),
            "/Users/nils/Google Drive File Stream/My Drive/BASiCS_add-on/Analysis/Revisions/CD4_activation_DEdown_DVdown.txt", sep = "\t", 
            row.names = FALSE, col.names = FALSE, quote = FALSE)

write.table(as.data.frame(rownames(df)[df$Regulation == "Down-regulated, higher variability"]),
            "/Users/nils/Google Drive File Stream/My Drive/BASiCS_add-on/Analysis/Revisions/CD4_activation_DEdown_DVup.txt", sep = "\t", 
            row.names = FALSE, col.names = FALSE, quote = FALSE)
```
